...
<div class="hero-wrap" style="display: flex; height: 100vh; overflow: hidden;">
    ...
    <div class="selection-container"
        ...
        <h1 style="color: #026dfe; text-align: center; margin-bottom: 20px;">Sign Up</h1>
        <div style="width: 100%; max-width: 500px; padding: 30px; border-radius: 10px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.2); background-color: rgba(255, 255, 255, 0.95);">
            <h2 style="color: #026dfe; text-align: center;">Create Your Account</h2>
            <p style="text-align: center; color: #555; margin-bottom: 20px;">Please select your account type to continue registration.</p>

            <div style="display: flex; justify-content: space-around; margin-top: 30px;">
                <!-- Customer Card -->
                <a href="Signup_form.php" style="text-decoration: none; color: inherit;">
                ...
                <!-- Company Card -->
                <a href="company_signup.php" style="text-decoration: none; color: inherit;">
                    <div style="text-align: center; cursor: pointer;">
